...
public class SimulationDriver {
    public static void main(String[] args) {
        ...
        final int TYPE = 2; //makes it easier to switch between modes, 1=multi, 2=single
        ...
        for (int i=0; i<studentCount; i++) {
            HashSet<Integer> responses = new HashSet<>();
            ...
            for (int j=1; j<answersChosen; j++) {
                ...
                responses.add(rand.nextInt(chosen));

                service.acceptSubmissions(studentList[i], responses);
            }
